		...
		<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
			<!-- Brand/logo -->
				...
				<ul class="nav navbar-nav">
					...
					<a class="dropdown-item" href="<c:url value="/cart/categorywise/${category.categoryId}"/>">${category.categoryName}</a>
					...
					<li><a href="<c:url value="/cart/productDisplay"/>">Product Display</a></li></ul></ul>
					<li class="nav-item"><a class="nav-link" href="<c:url value="/cart/cart"/>">My Cart</a></li></ul></ul>
					<li class="nav-item"><a class="nav-link" href="<c:url value="/cart/myorder"/>">MyOrder</a></li></ul>
					<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Category</a>
					<div class="dropdown-menu">
					<c:forEach items="${categoryList}" var="category">
					...
					<li><a class="nav-link" href="<c:url value="/perform_logout"/>">Logout</a></li></ul>
					</c:if>
