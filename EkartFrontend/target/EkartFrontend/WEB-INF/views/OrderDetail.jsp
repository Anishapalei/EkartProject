...
<tr>
	<td colspan="3"><a href="<c:url value="/user/cart"/>" class="btn btn-info">Move to Cart</a>
	<td colspan="2"><a href="<c:url value="/user/payment"/>" class="btn btn-info">Proceed Payment</a>
</tr>
